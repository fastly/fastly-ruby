...
require 'fastly/models/action'
require 'fastly/models/action_type'
require 'fastly/models/agent_key'
require 'fastly/models/agent_key_meta'
...
require 'fastly/models/bot_management_request_update_configuration'
...
require 'fastly/models/bot_management_response_configuration'
require 'fastly/models/bot_management_response_configuration_configuration'
require 'fastly/models/bot_management_response_configure'
...
require 'fastly/models/bulk_operation_result'
...
require 'fastly/models/condition_operator'
require 'fastly/models/condition_response'
require 'fastly/models/condition_type'
...
require 'fastly/models/directive'
...
require 'fastly/models/draft_diff'
require 'fastly/models/draft_update'
...
require 'fastly/models/header_event'
...
require 'fastly/models/initial_version'
require 'fastly/models/initial_version_path'
...
require 'fastly/models/inline_response20015'
require 'fastly/models/inline_response20016'
require 'fastly/models/inline_response20017'
require 'fastly/models/inline_response20018'
require 'fastly/models/inline_response20019'
require 'fastly/models/inline_response2002'
require 'fastly/models/inline_response20020'
require 'fastly/models/inline_response20021'
require 'fastly/models/inline_response20022'
...
require 'fastly/models/inline_response207'
require 'fastly/models/inline_response2071'
...
require 'fastly/models/kv_store_response_body_enable'
require 'fastly/models/kv_store_response_customer'
require 'fastly/models/kv_store_response_links'
require 'fastly/models/kv_store_response_links_links'
require 'fastly/models/kv_store_response_product'
require 'fastly/models/kv_store_response_product_product'
...
require 'fastly/models/notification'
require 'fastly/models/notification_config'
...
require 'fastly/models/operation_bulk_add_tags'
require 'fastly/models/operation_bulk_create'
require 'fastly/models/operation_bulk_create_operations'
require 'fastly/models/operation_bulk_delete'
require 'fastly/models/operation_create'
require 'fastly/models/operation_create_extra'
...
require 'fastly/models/page'
require 'fastly/models/page_create'
require 'fastly/models/page_update'
...
require 'fastly/models/pagination_meta1'
require 'fastly/models/path_change'
require 'fastly/models/path_create'
require 'fastly/models/path_response'
require 'fastly/models/path_response_all_of'
require 'fastly/models/path_update'
require 'fastly/models/path_with_rules'
require 'fastly/models/paths_response'
...
require 'fastly/models/policy'
require 'fastly/models/policy_create'
require 'fastly/models/policy_update'
...
require 'fastly/models/position'
...
require 'fastly/models/realtime_entry_datacenter'
...
require 'fastly/models/routing_config'
require 'fastly/models/routing_config_condition'
require 'fastly/models/routing_config_response'
require 'fastly/models/routing_config_response_all_of'
require 'fastly/models/routing_config_state'
require 'fastly/models/routing_config_version_response'
require 'fastly/models/routing_configs_response'
require 'fastly/models/rule_change'
require 'fastly/models/rule_create'
require 'fastly/models/rule_response'
require 'fastly/models/rule_response_all_of'
require 'fastly/models/rule_update'
require 'fastly/models/rules_response'
...
require 'fastly/models/script'
require 'fastly/models/script_update'
...
require 'fastly/models/security_header'
...
require 'fastly/models/versions_response'
require 'fastly/models/waf_simulate_request'
require 'fastly/models/waf_simulate_response'
require 'fastly/models/waf_simulate_signal'
require 'fastly/models/website'
require 'fastly/models/website_create'
require 'fastly/models/website_update'
...
require 'fastly/api/client_side_protection_api'
...
require 'fastly/api/dm_routing_configs_api'
...
require 'fastly/api/ngwaf_agent_keys_api'
require 'fastly/api/ngwaf_reports_api'
require 'fastly/api/ngwaf_simulate_api'
...
require 'fastly/api/product_kv_store_api'
