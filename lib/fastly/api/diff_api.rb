...
module Fastly
  class DiffApi
    ...
    # @return [DiffResponse]
    def diff_service_versions(opts = {})
      data, _status_code, _headers = diff_service_versions_with_http_info(opts)
      data
    end
    ...
    def diff_service_versions_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: DiffApi.diff_service_versions ...'
      end
      ...
      if @api_client.config.client_side_validation && service_id.nil?
        fail ArgumentError, "Missing the required parameter 'service_id' when calling DiffApi.diff_service_versions"
      end
      # verify the required parameter 'from_version_id' is set
      if @api_client.config.client_side_validation && from_version_id.nil?
        fail ArgumentError, "Missing the required parameter 'from_version_id' when calling DiffApi.diff_service_versions"
      end
      # verify the required parameter 'to_version_id' is set
      if @api_client.config.client_side_validation && to_version_id.nil?
        fail ArgumentError, "Missing the required parameter 'to_version_id' when calling DiffApi.diff_service_versions"
      end
      ...
      # resource path
      local_var_path = '/service/{service_id}/diff/from/{from_version_id}/to/{to_version_id}'.sub('{' + 'service_id' + '}', CGI.escape(service_id.to_s)).sub('{' + 'from_version_id' + '}', CGI.escape(from_version_id.to_s)).sub('{' + 'to_version_id' + '}', CGI.escape(to_version_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"DiffApi.diff_service_versions",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: DiffApi#diff_service_versions\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
