...
module Fastly
  class LoggingNewrelicApi
    ...
    # @option opts [Object] :format A Fastly [log format string](https://docs.fastly.com/en/guides/custom-log-formats). Must produce valid JSON that New Relic Logs can ingest.
