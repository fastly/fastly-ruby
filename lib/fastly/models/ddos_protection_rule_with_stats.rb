...
module Fastly
  class DdosProtectionRuleWithStats
    ...
    attr_accessor :source_ip_prefix
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Fastly::DdosProtectionRuleWithStats` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Fastly::DdosProtectionRuleWithStats`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'source_ip_prefix')
        self.source_ip_prefix = attributes[:'source_ip_prefix']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          host == o.host &&
          asn == o.asn &&
          source_ip_prefix == o.source_ip_prefix &&
    ...
    def hash
      [created_at, updated_at, id, name, action, customer_id, service_id, source_ip, country_code, host, asn, source_ip_prefix, additional_attributes, traffic_stats].hash
    end
