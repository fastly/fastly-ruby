...
module Fastly
  class KvStoreUpsertBatch
    ...
    attr_accessor :time_to_live_sec
    ...
    attr_accessor :background_fetch
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Fastly::KvStoreUpsertBatch` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Fastly::KvStoreUpsertBatch`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'time_to_live_sec')
        self.time_to_live_sec = attributes[:'time_to_live_sec']
      end
      ...
      if attributes.key?(:'background_fetch')
        self.background_fetch = attributes[:'background_fetch']
      else
    ...
    def ==(o)
      ...
      self.class == o.class &&
          key == o.key &&
          value == o.value &&
          time_to_live_sec == o.time_to_live_sec &&
          metadata == o.metadata &&
          background_fetch == o.background_fetch
    end
    ...
    def hash
      [key, value, time_to_live_sec, metadata, background_fetch].hash
    end
