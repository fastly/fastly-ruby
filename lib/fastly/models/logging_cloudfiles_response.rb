...
module Fastly
  class LoggingCloudfilesResponse
    ...
    def hash
      [name, placement, format_version, response_condition, format, message_type, timestamp_format, period, gzip_level, compression_codec, access_key, bucket_name, path, region, public_key, user, created_at, deleted_at, updated_at, service_id, version].hash
    end
