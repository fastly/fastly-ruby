...
module Fastly
  class LoggingGcsResponse
    ...
    def hash
      [name, placement, format_version, response_condition, format, message_type, timestamp_format, period, gzip_level, compression_codec, user, secret_key, bucket_name, path, public_key, created_at, deleted_at, updated_at, service_id, version].hash
    end
