...
module Fastly
  class LoggingSyslogResponse
    ...
    def hash
      [name, placement, format_version, response_condition, format, tls_ca_cert, tls_client_cert, tls_client_key, tls_hostname, address, port, message_type, hostname, ipv4, token, use_tls, created_at, deleted_at, updated_at, service_id, version].hash
    end
