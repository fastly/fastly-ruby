  ...
  class Script
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Fastly::Script` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Fastly::Script`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'current_hash')
        self.current_hash = attributes[:'current_hash']
      end

      if attributes.key?(:'authorized_hash')
        self.authorized_hash = attributes[:'authorized_hash']
      end
    ...
    def valid?
      authorization_status_validator = EnumAttributeValidator.new('String', ["authorized", "unauthorized"])
    ...
    def authorization_status=(authorization_status)
      validator = EnumAttributeValidator.new('String', ["authorized", "unauthorized"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          authorized_hash == o.authorized_hash &&
    ...
    def hash
      [id, page_id, source, urls, first_seen_at, last_seen_at, justification, current_hash, authorized_hash, authorization_status, authorized_at].hash
    end
