...
module Fastly
  class TlsBulkCertificateDataAttributes
    ...
    attr_accessor :intermediates_blob
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Fastly::TlsBulkCertificateDataAttributes` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Fastly::TlsBulkCertificateDataAttributes`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'allow_untrusted_root')
        ...
        self.allow_untrusted_root = false
      end
      ...
      if attributes.key?(:'intermediates_blob')
        self.intermediates_blob = attributes[:'intermediates_blob']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          intermediates_blob == o.intermediates_blob
    end
    ...
    def hash
      [allow_untrusted_root, cert_blob, intermediates_blob].hash
    end
